        ...
        <div className='relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
          <div className='flex flex-col items-center justify-between xl:flex-row'>
            <div className='w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12'>
              <h2 className='max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none sm:my-4 sm:drop-shadow-lg'>
                Smart Crowdfunding <br className='hidden md:block' />
                Ethereum - Next.js
              </h2>
              <p className='max-w-xl mb-4 text-base text-gray-200 md:text-lg'>
                Crowdfunding meets the future: where innovation,
                decentralization, and trust converge on the Ethereum blockchain,
                transforming ideas into reality with the power of Next.js and
                the security of Hardhat and Solidity.
              </p>
              <a
                href='/'
                aria-label=''
